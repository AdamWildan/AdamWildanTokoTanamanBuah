	...
	<div style="width: 100%;">
		...
		<table class="table table-hover table-stripped">
			...
			<thead>
				...
				<td>no</td><td>Plants Name</td><td>Plants Age</td><td>Category</td><td>Price</td><td>Image</td><td>Country</td><td>Botanist</td><td>Stock</td><td></td><td></td>
...
<table class="table table-stripped table-hover">
	...
	<tr><td colspan="2">Buyer Name</td><td colspan="4"><input type="text" name="pembeli" value="<?=$this->session->flashdata('pembeli');?>"></td></tr>


				<tr>

				<th>No</th><th>Plants Name</th><th>Total</th><th>Price</th><th>SubTotal</th><th></th>
		...
		<tr><td colspan="2">Return</td><td colspan="4"><input type="number" value="<?= $this->session->flashdata('kembali') ?>" name="kembali"></td></tr>
